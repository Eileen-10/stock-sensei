        ...
        <div>
            <div className="flex flex-col">
                <div className="flex justify-between">
                    ...
                    <button onClick={()=>{updateData()}}><img src="https://cdn-icons-png.flaticon.com/128/3161/3161390.png" className="scale-[0.25]"></img></button>
                </div>
                <div className="grid grid-cols-3 gap-12">
                    {ioData.map((inv)=>(
                        <a href={inv.name == "Chicken" ? "/forecast" : "#"}>
            ...
            <div className="flex flex-col mt-8">
                ...
                <div className="flex flex-col">
                    {forecastData.map((forecast)=>(
                        <a href={forecast.name == "Chicken" ? "/forecast" : "#"}>
